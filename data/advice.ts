...
`
    ...
    {
        slug: 'traduire-coran-asharisme-atharisme-salafisme-vs-madhabs',
        title: "Traduire le Coran, Comprendre Allah : Ash'arisme, Atharisme/Salafisme et la Différence Fondamentale avec les Madhabs",
        excerpt: "Depuis la traduction latine commandée en 1143 par un abbé chrétien hostile jusqu'aux éditions saoudiennes contemporaines, traduire le Coran n'a jamais été un geste neutre : chaque choix de mot trahit une théologie. Ash'arisme et Atharisme/Salafisme ne sont pas des Madhabs — ce sont deux méthodes différentes pour comprendre les versets sur la Main, le Visage ou l'Établissement d'Allah sur le Trône. Voici, exemples coraniques à l'appui, ce qui les distingue réellement.",
        date: '2026-06-20',
        author: 'Équipe 40 Jours',
        readTime: '16 min',
        category: 'Sciences & Compréhension',
        content: `
# Traduire le Coran, Comprendre Allah : Ash'arisme, Atharisme/Salafisme et la Différence Fondamentale avec les Madhabs

Il existe un paradoxe au cœur de la relation entre le Coran et ses lecteurs non-arabophones : le texte affirme lui-même son inimitabilité absolue — son *I'jaz*, déjà détaillé dans notre article dédié — et pourtant, des centaines de millions de musulmans à travers le monde n'accèdent à son sens qu'à travers une traduction. Ce paradoxe n'est pas qu'une curiosité linguistique. Il est, depuis quatorze siècles, le terrain où se rencontrent et parfois s'affrontent des écoles théologiques entières, car traduire un verset sur "la Main d'Allah" ou Son "Établissement" sur le Trône suppose déjà d'avoir tranché, consciemment ou non, une question vieille de mille deux cents ans : comment doit-on comprendre les attributs d'Allah décrits dans le Livre ? C'est cette question — et la confusion fréquente qu'elle entretient avec le débat sur les Madhabs déjà traité dans notre article *"Comprendre les 4 Madhabs"* — que cet article se propose de démêler, exemple coranique après exemple coranique.

## 1. Un Livre Réputé Intraduisible

Les savants classiques ont toujours établi une distinction stricte entre le Coran lui-même — Parole d'Allah en langue arabe, miraculeuse dans sa forme autant que dans son fond — et toute tentative de rendre son sens dans une autre langue. C'est pour cette raison que la terminologie islamique préfère, en théorie, l'expression *"tarjama ma'nawiyya"* (traduction du sens) ou *"tafsir"* (exégèse) au terme brut de "traduction", qui suggérerait une équivalence totale impossible à atteindre. Une traduction n'est jamais le Coran : c'est une compréhension humaine, datée et faillible, du sens des versets — ce qui explique pourquoi aucune traduction, fût-elle réalisée par le plus grand savant, ne peut être récitée dans la prière à la place du texte arabe original.

Cette prudence n'a cependant jamais interdit l'effort de traduction lui-même, dont la nécessité s'est imposée dès les premières décennies de l'expansion de l'Islam hors de la péninsule arabique. Selon un récit largement rapporté par les commentateurs, le compagnon persan Salman al-Farisi aurait traduit la sourate Al-Fatiha en persan à la demande de nouveaux convertis incapables encore de la prononcer correctement en arabe — un épisode souvent cité par les juristes hanafites pour justifier, à titre dérogatoire et temporaire, la récitation en langue vernaculaire pour celui qui n'a aucun moyen d'apprendre l'arabe, une position que les générations hanafites postérieures ont d'ailleurs largement restreinte.

## 2. Les Premières Traductions Européennes : Une Histoire Souvent Hostile

La première traduction intégrale du Coran dans une langue européenne ne naît pas d'un désir de compréhension mutuelle, mais d'un projet polémique. En 1143, l'abbé de Cluny **Pierre le Vénérable** commande à l'Anglais **Robert de Ketton** une traduction latine — intitulée de façon révélatrice *Lex Mahumet pseudoprophete* ("La loi de Mahomet, faux prophète") — explicitement destinée à fournir aux théologiens chrétiens des arguments de réfutation. Le travail de Ketton, truffé d'approximations et d'ajouts polémiques, servira pourtant de base, directement ou indirectement, à la plupart des traductions européennes ultérieures pendant près de cinq siècles.

Ce n'est qu'en 1698 que le moine italien **Ludovico Marracci** produit la première traduction latine véritablement savante, fondée sur une lecture méthodique des commentateurs musulmans classiques — bien qu'accompagnée, elle aussi, de réfutations chrétiennes en marge. L'Anglais **George Sale**, en 1734, s'appuiera largement sur le travail de Marracci pour livrer une traduction anglaise réputée plus équilibrée, qui restera une référence en Europe pendant près de deux siècles, y compris pour des penseurs des Lumières comme Voltaire.

## 3. La France et le Coran : Du Ryer, Kazimirski, Hamidullah

La première traduction française directement réalisée à partir du texte arabe — et non via le latin — est celle d'**André du Ryer**, *L'Alcoran de Mahomet*, publiée en 1647. Malgré ses imperfections, elle connaît un succès considérable et servira même de base, en 1649, à la première traduction anglaise d'Alexander Ross. Suivront la traduction de **Claude-Étienne Savary** (1783), puis celle d'**Albin de Biberstein Kazimirski** (1840), longtemps la plus diffusée en français au XIXe siècle.

Le XXe siècle voit l'entrée en scène de traducteurs musulmans eux-mêmes. **Muhammad Hamidullah**, savant indien installé à Paris, publie en 1959 *Le Saint Coran*, première traduction française réalisée par un musulman pratiquant, qui deviendra la référence de plusieurs générations de musulmans francophones — son texte sera plus tard imprimé sous le patronage du Complexe du Roi Fahd de Médine. **Si Hamza Boubakeur**, recteur de la Grande Mosquée de Paris, publie en 1972 une traduction en plusieurs volumes accompagnée d'un commentaire substantiel. Parallèlement, des traductions à vocation académique ou littéraire — celle de l'arabisant **Régis Blachère** (1947-1950), puis celles de **Denise Masson** (1967, intégrée à la collection de la Pléiade), de **Jacques Berque** (1990) et d'**André Chouraqui** (1990, dans une perspective comparatiste avec la Bible hébraïque) — proposent des lectures davantage philologiques que confessionnelles, et dès lors moins marquées par un positionnement théologique explicite.

## 4. Quand la Traduction Devient un Manifeste Théologique : le Cas Hilali-Khan

L'exemple le plus net de traduction explicitement orientée par une école théologique précise est sans doute celui de *The Noble Qur'an*, traduction anglaise de **Muhammad Taqi-ud-Din al-Hilali** et **Muhammad Muhsin Khan**, publiée et diffusée massivement par le Complexe du Roi Fahd pour l'Impression du Saint Coran à Médine à partir des années 1980. Ce texte ajoute, entre crochets, de très nombreuses précisions théologiques explicites — par exemple, pour le verset de l'Établissement d'Allah sur le Trône, la traduction précise systématiquement *"rose over (Istawa) the Throne (really in a manner that suits His Majesty)"* en renvoyant en note aux positions d'Ibn Taymiyya et d'Ibn Kathir, rejetant explicitement toute interprétation allégorique. À l'inverse, des traductions comme celle de **Muhammad Asad**, *The Message of the Qur'an* (1980), connue pour son rendu très allégorique et rationaliste des versets sur les attributs divins — au point d'avoir fait l'objet d'une interdiction de diffusion en Arabie saoudite pour des raisons théologiques — illustrent l'autre extrémité du spectre. Entre ces deux pôles, la traduction d'**Abdullah Yusuf Ali** (1934) occupe une position intermédiaire, oscillant entre affirmation et interprétation symbolique selon les passages.

C'est précisément cette tension entre les choix de traduction qui nous conduit au cœur du sujet : pour comprendre pourquoi un même verset arabe donne lieu à des rendus aussi différents, il faut comprendre les écoles théologiques qui les sous-tendent — et bien les distinguer d'un autre débat, totalement indépendant, celui des Madhabs.

## 5. 'Aqida et Fiqh : Deux Sciences Qu'il Ne Faut Jamais Confondre

La tradition islamique distingue nettement deux grandes branches du savoir religieux. La première, le *Fiqh* (la jurisprudence), répond à la question : **comment agir** ? Comment prier, jeûner, se marier, héritier, commercer ? C'est le domaine des quatre grands Madhabs sunnites — Hanafite, Malikite, Shafi'ite, Hanbalite — déjà détaillés dans notre article dédié, des écoles méthodologiques qui partagent les mêmes sources (Coran, Sunna, Consensus, Analogie) mais diffèrent sur certains points d'application pratique.

La seconde branche, l'*'Aqida* (la croyance, ou *Usul al-Din*, les fondements de la religion), répond à une question radicalement différente : **que croire** ? Comment comprendre la nature d'Allah, Ses attributs, le libre arbitre et le Destin (*Qadar*, déjà traité dans notre article dédié), la nature du Coran lui-même, l'eschatologie ? C'est dans ce second domaine, et non dans celui du Fiqh, que se situent l'Ash'arisme, le Maturidisme et l'Atharisme — souvent désigné aujourd'hui sous le nom de Salafisme dans sa forme contemporaine. Confondre ces deux axes — comme le fait souvent le débat public, y compris en France — revient à confondre une question de grammaire avec une question de géographie : ce sont deux sciences distinctes, qui répondent à deux questions différentes, et qui s'articulent selon des logiques propres.

## 6. Le Repoussoir Commun : les Mu'tazilites

Pour comprendre la naissance de l'Ash'arisme et de l'Atharisme tels qu'on les connaît aujourd'hui, il faut d'abord connaître le courant contre lequel ils se sont, chacun à sa manière, construits : le **Mu'tazilisme**. Apparu au VIIIe siècle à Bassora, ce courant rationaliste appliquait une logique grecque héritée de la philosophie hellénistique à l'ensemble des questions théologiques, allant jusqu'à nier toute réalité aux attributs divins mentionnés dans le Coran — la Main, le Visage, l'Établissement sur le Trône — qu'il interprétait comme de pures métaphores littéraires, sous peine selon lui de "ressembler la création" (*tashbih*). Les Mu'tazilites soutenaient également que le Coran était une parole **créée** par Allah, et non un attribut éternel et incréé de Sa Parole — une thèse qui allait provoquer l'un des épisodes les plus dramatiques de l'histoire intellectuelle musulmane.

Sous les califes abbassides **Al-Ma'mun**, **Al-Mu'tasim** et **Al-Wathiq**, entre 833 et 848, le Mu'tazilisme devient doctrine d'État, et une véritable **Inquisition** (*Al-Mihna*) est organisée pour contraindre savants et juges à proclamer publiquement que le Coran est créé. L'imam **Ahmad ibn Hanbal**, refusant catégoriquement cette position, est emprisonné et flagellé à plusieurs reprises pour son refus, comme le rapporte en détail **Al-Dhahabi** dans *Siyar A'lam al-Nubala'*. Cet épisode fondateur explique pourquoi le courant qui se réclame de la fidélité littérale aux textes — l'Atharisme, ou *Ahl al-Hadith* — s'est historiquement construit en opposition directe au rationalisme mu'tazilite, et pourquoi Ahmad ibn Hanbal en demeure, jusqu'à aujourd'hui, la figure de référence absolue.

## 7. L'École Athari : Affirmer Sans Anthropomorphisme

L'école atharie (du mot *athar*, "la trace", désignant les traces laissées par les textes du Coran et de la Sunna et la compréhension des premières générations, les *Salaf*) tient pour principe que les versets décrivant des attributs divins — la Main, le Visage, l'Établissement sur le Trône — doivent être pris dans leur sens apparent, comme désignant des attributs réels d'Allah, **sans pour autant leur attribuer aucune ressemblance avec les attributs créés**. La formule classique, attribuée dans plusieurs sources anciennes — notamment **Al-Bayhaqi** dans *Al-Asma' wa al-Sifat* et **Al-Lalaka'i** dans *Sharh Usul al-I'tiqad* — à l'imam Malik ibn Anas lorsqu'on l'interrogea sur le sens de l'Établissement d'Allah sur le Trône, résume cette méthode en une phrase devenue célèbre : *"al-Istiwa ghayru majhul, wal-kayfu ghayru ma'qul, wal-iqraru bihi al-iman, wal-jahdu bihi kufr"* — *"L'Établissement [en lui-même] n'est pas inconnu [il a un sens], la modalité [le 'comment'] n'est pas concevable [par la raison], l'affirmer relève de la foi, et le nier relève de la mécréance."*

Cette méthode, systématisée plusieurs siècles plus tard par **Ibn Taymiyya** (m. 1328) dans des ouvrages comme *Al-'Aqida al-Wasitiyya* et *Dar' Ta'arud al-'Aql wal-Naql*, se résume en quatre négations conjointes : ni *tashbih* (assimiler Allah à la création), ni *ta'til* (nier le sens réel de l'attribut), ni *tahrif* (déformer le sens du texte), ni *takyif* (s'interroger sur la modalité concrète de l'attribut). L'attribut est affirmé, sa signification est acceptée dans son sens apparent, mais toute comparaison avec les créatures est rejetée — d'où la formule synthétique souvent citée : *"Ithbat ma'a Tanzih"*, l'affirmation conjuguée à la transcendance.

## 8. Abu al-Hasan al-Ash'ari et la Naissance du Kalam Sunnite

C'est dans ce climat de tension entre le rationalisme mu'tazilite et le littéralisme atharien qu'émerge, à Bagdad, la figure d'**Abu al-Hasan al-Ash'ari** (m. 936). Ancien mu'tazilite converti, selon la tradition biographique rapportée notamment par **Ibn 'Asakir** dans *Tabyin Kadhib al-Muftari*, après un songe dans lequel le Prophète ﷺ lui serait apparu pour lui ordonner de défendre la doctrine transmise par les textes (*hadith*), Al-Ash'ari développe une méthode intermédiaire : utiliser les outils du *kalam* (la théologie rationnelle, les mêmes outils dialectiques que les Mu'tazilites) non pas pour nier les croyances orthodoxes héritées des premières générations, mais au contraire pour les **défendre rationnellement** contre les attaques rationalistes.

Sur la question précise des attributs, la position ash'arite a connu une évolution interne notable. Dans son ouvrage de jeunesse *Al-Ibana 'an Usul al-Diyana*, rédigé après sa rupture avec le Mu'tazilisme, Al-Ash'ari affirme les attributs dans un sens très proche de la position atharie. C'est surtout chez ses successeurs — **Al-Baqillani**, **Al-Juwayni**, puis **Fakhr al-Din al-Razi** — que se systématise une seconde méthode, plus rationaliste : distinguer entre les **attributs essentiels** (*Sifat Dhatiyya* : la Science, la Puissance, la Volonté, l'Ouïe, la Vue, la Parole, la Vie), affirmés littéralement par l'ensemble des Ash'arites, et les **attributs dits "rapportés"** (*Sifat Khabariyya* : la Main, le Visage, l'Établissement, l'Œil), traités selon deux méthodes possibles : le *tafwid* (consigner le sens précis à la connaissance d'Allah, tout en affirmant que l'attribut est vrai et n'est pas comparable à ses équivalents créés) ou le *ta'wil* (l'interprétation allégorique, par exemple la Main comprise comme la Puissance ou la Bienfaisance, le Visage comme l'Essence divine, l'Établissement comme la Domination — *istawla* plutôt qu'*istawa*).

Cette école deviendra, à travers des figures majeures comme **Al-Ghazali** (déjà très largement présenté dans cette application), **Al-Razi**, **Al-Baqillani**, **Al-Nawawi** ou **Ibn Hajar al-Asqalani**, la théologie officiellement enseignée dans des institutions comme **Al-Azhar** au Caire, et la position majoritaire parmi les juristes shafi'ites et malikites à travers l'histoire.

## 9. Al-Maturidi : Le Troisième Pilier, Souvent Oublié en France

Contemporain presque exact d'Al-Ash'ari, **Abu Mansur al-Maturidi** (m. 944) développe, depuis Samarcande en Asie centrale, une synthèse théologique très proche dans ses conclusions de celle d'Al-Ash'ari, exposée notamment dans son *Kitab al-Tawhid*, bien que les deux écoles divergent sur quelques points techniques de détail (notamment sur la nature exacte de la foi, ou sur certaines questions liées au libre arbitre humain). Le Maturidisme deviendra, à travers l'adoption massive de l'école juridique hanafite dans l'Empire ottoman, en Asie centrale et dans le sous-continent indien, la théologie de référence d'une part considérable du monde musulman — ce qui explique pourquoi la plupart des manuels classiques regroupent traditionnellement Ash'arisme et Maturidisme sous l'appellation commune d'*"Ahl al-Sunna wal-Jama'a min Ahl al-Kalam"*, par contraste avec l'Atharisme, désigné comme *"Ahl al-Sunna min Ahl al-Hadith wal-Athar"*.

## 10. Le Réveil Contemporain de l'Atharisme : Du Najd au Salafisme Mondial

L'Atharisme classique, porté pendant des siècles principalement par l'école hanbalite, connaît une systématisation décisive avec **Ibn Taymiyya** au XIVe siècle, puis une traduction politique avec le mouvement de réforme religieuse de **Muhammad ibn Abd al-Wahhab** dans la région du Najd au XVIIIe siècle, à l'origine de ce que l'on désigne souvent, de façon générique et parfois imprécise, sous le terme de "wahhabisme". Le XXe siècle voit l'émergence d'un mouvement se revendiquant explicitement de l'héritage des *Salaf* (les trois premières générations de l'Islam) — le **Salafisme** contemporain — porté par des savants comme **Nasir al-Din al-Albani**, **Abd al-Aziz ibn Baz** ou **Muhammad ibn Salih al-'Uthaymin**, principalement diffusé depuis l'Arabie saoudite à travers ses institutions d'enseignement et ses maisons d'édition, dont le Complexe du Roi Fahd déjà mentionné pour la traduction Hilali-Khan.

Il convient ici d'une précision méthodologique importante : le terme "Salafiyya" a également été utilisé, à la fin du XIXe et au début du XXe siècle, par des réformateurs comme **Muhammad Abduh** ou **Jamal al-Din al-Afghani**, dans un sens très différent — celui d'un retour aux sources pour moderniser l'Islam face à la colonisation, parfois avec des sympathies rationalistes proches du Mu'tazilisme. C'est bien de l'Atharisme doctrinal hanbalite, et de sa forme contemporaine institutionnalisée depuis l'Arabie saoudite, qu'il est question dans cet article lorsqu'on évoque le "Salafisme" en tant que courant théologique.

## 11. Cinq Versets, Deux Méthodes : les Exemples Concrets

C'est à travers des exemples coraniques précis que la différence entre ces écoles devient la plus tangible.

**L'Établissement sur le Trône (Al-Istiwa).** Six versets emploient l'expression *"thumma istawa 'ala al-'Arsh"* ou *"Ar-Rahmanu 'ala al-'Arshi istawa"* (Sourate Al-A'raf, 7:54 ; Sourate Ta-Ha, 20:5 ; et quatre autres occurrences). L'école atharie affirme le sens apparent — un Établissement réel, sans précision de modalité, sans comparaison avec un trône humain. L'école ash'arite, selon les auteurs, affirme le sens littéral sans en préciser la modalité (*tafwid*) ou l'interprète comme la Domination (*istiwa* compris comme *istiwla*).

**La Main d'Allah (Al-Yad).** La Sourate Al-Fath, 48:10, évoque *"Yadu Allahi fawqa aydihim"* ("la Main d'Allah est au-dessus de leurs mains") à propos du serment d'allégeance ; la Sourate Sad, 38:75, rapporte qu'Allah dit à Iblis : *"limā khalaqtu biyadayya"* ("ce que J'ai créé de Mes deux Mains"), à propos d'Adam. Les Atharis y voient un attribut réel de Main, sans ressemblance avec une main créée. De nombreux Ash'arites tardifs l'interprètent comme la Puissance ou la Bienfaisance divine.

**Le Visage d'Allah (Al-Wajh).** La Sourate Ar-Rahman, 55:27, annonce : *"wa yabqa wajhu rabbika dhu al-jalali wal-ikram"* ("et il subsistera le Visage de ton Seigneur, Détenteur de la Majesté et de la Munificence") ; la Sourate Al-Qasas, 28:88, précise : *"kullu shay'in halikun illa wajhah"* ("toute chose périra sauf Son Visage"). Les Atharis affirment un Visage réel, sans comparaison avec un visage créé ; nombre d'Ash'arites l'interprètent comme désignant l'Essence (*Dhat*) divine elle-même.

**L'Œil d'Allah (Al-'Ayn).** À propos de l'Arche de Noé, la Sourate Hud, 11:37, dit : *"wasna' al-fulka bi-a'yunina"* ("construis l'arche sous Nos yeux"), formule reprise dans la Sourate Al-Qamar, 54:14. Même schéma de divergence méthodologique : affirmation littérale sans anthropomorphisme d'un côté, interprétation comme la Surveillance ou la Protection divine de l'autre.

**Un point de convergence : la Vision d'Allah au Paradis (Ru'yat Allah).** Il est essentiel de souligner que ces deux écoles ne sont pas systématiquement en désaccord. La Sourate Al-Qiyamah, 75:22-23, annonce : *"Wujuhun yawma'idhin nadirah, ila rabbiha nazirah"* ("Certains visages, ce Jour-là, seront resplendissants, regardant leur Seigneur"). Sur ce point précis — la possibilité, pour les croyants au Paradis, de **voir littéralement** Allah — Ash'arites et Atharis sont en plein accord, contre la position mu'tazilite qui niait toute possibilité de vision divine, jugée par elle incompatible avec la transcendance d'Allah.

**La Parole d'Allah et le statut du Coran (Kalam Allah).** Le débat sur la nature incréée ou créée du Coran, au cœur de la Mihna déjà évoquée, s'appuie notamment sur la Sourate An-Nisa, 4:164, qui affirme : *"wa kallama Allahu Musa takliman"* ("et Allah parla à Moïse, réellement"), ainsi que sur la Sourate Az-Zukhruf, 43:3, dont la formule *"Inna ja'alnahu Qur'anan 'Arabiyyan"* ("Nous en avons fait un Coran arabe") fut utilisée par les Mu'tazilites pour soutenir que le Coran était une chose créée. Athari et Ash'ari rejettent tous deux cette dernière conclusion, mais avec des nuances : les Atharis affirment que le Coran, dans sa lettre comme dans son sens, est la Parole incréée et éternelle d'Allah ; certains Ash'arites distinguent entre le sens éternel de la Parole divine (*Kalam Nafsi*) et son expression verbale en lettres et en sons, considérée comme l'expression créée de cette Parole éternelle.

## 12. Pourquoi Cette Distinction Théologique Compte Réellement

Ces désaccords ne relèvent pas d'une simple querelle d'érudits sans conséquence pratique. La manière de comprendre les attributs d'Allah façonne directement le rapport du croyant à son Créateur : une affirmation trop littérale, mal expliquée, risque de glisser vers l'anthropomorphisme (*tashbih*) — un Allah conçu à l'image de Sa création — tandis qu'une interprétation trop systématiquement allégorique risque de vider les textes de leur substance et de glisser vers la négation (*ta'til*), l'écueil reproché historiquement aux Mu'tazilites et, plus tard, aux courants philosophiques rationalistes. C'est précisément entre ces deux écueils que se situent, chacune avec sa méthode propre, l'École Ash'arite/Maturidite et l'École Athari — un point sur lequel l'immense majorité des savants classiques des deux courants, des biographes comme **Al-Subki** dans *Tabaqat al-Shafi'iyya al-Kubra* jusqu'aux institutions contemporaines, situent les deux écoles à l'intérieur du cadre commun de *Ahl al-Sunna wal-Jama'a*, malgré les tensions parfois vives — notamment en ligne — qui opposent aujourd'hui certains de leurs partisans respectifs.

## 13. La Différence Fondamentale avec les Madhabs : Deux Axes, Pas Un Seul

Voici le cœur de la confusion qu'il faut absolument lever. Le Madhab répond à la question du **comment agir** (Fiqh) ; l'école 'aqidique répond à la question du **que croire** (Théologie). Ce sont deux axes de classification totalement indépendants, qui se sont historiquement combinés de presque toutes les manières possibles à travers le monde musulman :

- Un musulman **hanafite** en Fiqh est, le plus souvent historiquement, **maturidite** en 'Aqida — c'était la combinaison officielle de l'Empire ottoman et reste dominante en Asie centrale et dans le sous-continent indien — mais il peut aussi être athari (cas de nombreux hanafites contemporains influencés par le Salafisme) ou même ash'arite (cas observé chez certains hanafites du Levant et d'Égypte).
- Un musulman **shafi'ite** ou **malikite** en Fiqh est, historiquement et très majoritairement, **ash'arite** en 'Aqida — c'est la combinaison la plus répandue en Afrique du Nord, au Levant, en Afrique de l'Est et en Asie du Sud-Est — bien que l'imam Malik lui-même, antérieur d'un siècle à Al-Ash'ari, exprimait sur la question de l'Établissement une position très proche, dans sa formulation, de ce que l'on appellera plus tard la méthode atharie.
- Un musulman **hanbalite** en Fiqh est très généralement **athari** en 'Aqida — Ahmad ibn Hanbal étant la figure fondatrice commune des deux courants — bien que l'histoire ait connu des hanbalites aux sympathies partiellement ash'arites, comme **Ibn al-Jawzi** sur certaines questions, preuve supplémentaire que ces deux axes ne sont jamais parfaitement superposables.
- Le **Salafisme contemporain**, enfin, ajoute une complexité supplémentaire : sur le plan de l'Aqida, il se revendique systématiquement athari ; mais sur le plan du Fiqh, une partie significative de ses adeptes revendique explicitement de ne suivre **aucun Madhab particulier**, préférant une démarche dite *"La Madhabiyya"* consistant à choisir, question par question, l'avis juridique jugé le mieux étayé par les preuves textuelles directes — une posture méthodologique qui concerne le Fiqh, et non l'Aqida, mais qui leur est souvent associée dans la perception populaire.

Choisir de prier selon le rite hanafite, malikite, shafi'ite ou hanbalite ne renseigne donc absolument rien, en soi, sur la manière dont on comprend l'Établissement d'Allah sur le Trône ou la nature exacte de la Parole divine — et inversement, partager une même position sur les attributs divins n'implique en rien de partager la même méthode de calcul d'un héritage ou de validité d'une vente. Ce sont, encore une fois, deux questions différentes posées par deux branches différentes de la science islamique.

## Conclusion : Une Même Boussole, Deux Méthodes

Au terme de ce parcours — des traductions latines hostiles du XIIe siècle aux éditions saoudiennes contemporaines, de la Mihna d'Ahmad ibn Hanbal à la synthèse rationnelle d'Al-Ash'ari — une conclusion s'impose : Ash'arisme, Maturidisme et Atharisme/Salafisme ne sont pas trois religions différentes, ni même trois branches concurrentes de l'Islam au sens où le seraient le sunnisme et le chiisme. Ce sont trois **méthodes** distinctes, élaborées à des époques et dans des contextes différents, pour répondre à une même exigence : préserver le *Tawhid* — l'Unicité et la transcendance absolues d'Allah — contre les deux dérives symétriques que sont l'anthropomorphisme et la négation pure et simple des attributs divins révélés dans le Coran. Connaître précisément leurs arguments respectifs, plutôt que de réduire ce débat à une opposition binaire et caricaturale, est la condition nécessaire pour aborder ces questions — y compris en France, où elles traversent aujourd'hui de nombreuses mosquées et associations — avec la rigueur, la mesure et le respect mutuel que le Coran lui-même recommande : *"Et cramponnez-vous tous ensemble au câble d'Allah, ne soyez pas divisés"* (Sourate Al-Imran, 3:103).

---

**Sources et bibliographie :**
- **Sourate Al-A'raf**, 7:54 ; **Sourate Ta-Ha**, 20:5 — l'Établissement d'Allah sur le Trône (Al-Istiwa).
- **Sourate Al-Fath**, 48:10 ; **Sourate Sad**, 38:75 — les versets relatifs à la Main d'Allah (Al-Yad).
- **Sourate Ar-Rahman**, 55:27 ; **Sourate Al-Qasas**, 28:88 — les versets relatifs au Visage d'Allah (Al-Wajh).
- **Sourate Hud**, 11:37 ; **Sourate Al-Qamar**, 54:14 — les versets relatifs à l'Œil d'Allah (Al-'Ayn).
- **Sourate Al-Qiyamah**, 75:22-23 — la Vision d'Allah au Paradis (Ru'yat Allah), point de convergence entre Ash'arisme et Atharisme.
- **Sourate An-Nisa**, 4:164 ; **Sourate Az-Zukhruf**, 43:3 — les versets au cœur du débat sur la nature incréée du Coran (Kalam Allah).
- **Sourate Al-Imran**, 3:103 — l'appel coranique à l'unité de la communauté.
- **Al-Bayhaqi**, *Al-Asma' wa al-Sifat* ; **Al-Lalaka'i**, *Sharh Usul al-I'tiqad* — le récit de la position de l'imam Malik sur l'Istiwa.
- **Al-Ash'ari**, *Al-Ibana 'an Usul al-Diyana* et *Maqalat al-Islamiyyin* — les œuvres fondatrices de l'école ash'arite.
- **Al-Maturidi**, *Kitab al-Tawhid* — l'œuvre fondatrice de l'école maturidite.
- **Ibn Taymiyya**, *Al-'Aqida al-Wasitiyya* et *Dar' Ta'arud al-'Aql wal-Naql* — la systématisation classique de l'école athari.
- **Ibn 'Asakir**, *Tabyin Kadhib al-Muftari* — biographie et défense de l'imam Al-Ash'ari.
- **Al-Dhahabi**, *Siyar A'lam al-Nubala'* — le récit de la Mihna et de la persécution de l'imam Ahmad ibn Hanbal.
- **Al-Subki**, *Tabaqat al-Shafi'iyya al-Kubra* — classification historique des grands savants ash'arites.
- **Hartmut Bobzin**, travaux sur les traductions latines médiévales du Coran ; **Travis Zadeh**, *The Vernacular Qur'an*.
- **Muhammad Hamidullah**, *Le Saint Coran* (1959) ; **Si Hamza Boubakeur**, *Le Coran* (1972) ; **Régis Blachère**, *Le Coran* (1947-1950).
- En complément : nos articles *"Comprendre les 4 Madhabs : Miséricorde, pas Division"*, *"Le Destin (Qadar) pour les nuls"* et *"L'I'jaz du Coran : Pourquoi personne ne peut l'imiter après 14 siècles"*.
`
    },
    {
        slug: 'trois-ecoles-aqida-sunnite-asharisme-maturidisme-atharisme',
        title: "Ash'arisme, Maturidisme, Atharisme : Portrait des Trois Grandes Écoles de la 'Aqida Sunnite",
        excerpt: "Trois noms savants, trois méthodes, un même amour pour le Tawhid. Plutôt que d'opposer Ash'arites, Maturidites et Atharis, découvrez ce que chacune de ces écoles a véritablement apporté à l'Islam : la rigueur de l'argumentation, l'équilibre entre raison et texte, la fidélité aux premières générations. Un portrait bienveillant, sourcé école par école.",
        date: '2026-06-20',
        author: 'Équipe 40 Jours',
        readTime: '12 min',
        category: 'Sciences & Compréhension',
        content: `
# Ash'arisme, Maturidisme, Atharisme : Portrait des Trois Grandes Écoles de la 'Aqida Sunnite

Dans notre article précédent sur l'histoire des traductions du Coran, nous avons posé une distinction essentielle : l'*'Aqida* (la croyance) et le *Fiqh* (la jurisprudence) répondent à deux questions différentes, et ne doivent jamais être confondus avec les quatre Madhabs déjà présentés dans notre article *"Comprendre les 4 Madhabs"*. Nous avons également esquissé les grandes lignes des trois écoles théologiques reconnues au sein de *Ahl al-Sunna wal-Jama'a* : l'Ash'arisme, le Maturidisme et l'Atharisme. Cet article leur consacre, à chacune, un portrait approfondi — non pas pour les opposer, mais pour comprendre, avec bienveillance et précision, ce que chacune a véritablement apporté à l'héritage intellectuel et spirituel de l'Islam, et pourquoi des générations entières de savants pieux et sincères ont choisi, chacune à son époque et selon son contexte, de s'y rattacher.

## Un Socle Commun Avant Toute Nuance

Avant d'entrer dans le détail de chaque école, il faut insister sur ce qui les unit, car cela représente l'écrasante majorité de la croyance islamique : les trois écoles affirment sans exception les six piliers de la foi déjà détaillés dans notre article *"Aqeedah pour débutants"* — la croyance en Allah, en Ses anges, en Ses livres, en Ses messagers, au Jour Dernier et au Destin. Toutes trois reconnaissent l'autorité absolue du Coran et de la Sunna authentique, rejettent catégoriquement le Mu'tazilisme et sa négation des attributs divins, affirment la possibilité de la vision d'Allah au Paradis (*Ru'yat Allah*, Sourate Al-Qiyamah, 75:22-23), et combattent ensemble les deux mêmes dérives : l'anthropomorphisme (*tashbih*, comparer Allah à Sa création) et la négation des attributs (*ta'til*). Leurs divergences, réelles, portent sur la **méthode** à employer pour atteindre et formuler cette croyance commune — non sur son contenu fondamental. C'est dans cet esprit, celui d'une même maison aux pièces agencées différemment, qu'il faut lire ce qui suit.

## L'École Ash'arite : La Raison Mise au Service de la Révélation

### Une conversion qui a changé l'histoire de la théologie

**Abu al-Hasan al-Ash'ari** naît à Bassora en 874 et meurt à Bagdad en 936. Il passe la première partie de sa vie comme théologien mu'tazilite accompli, formé auprès du grand maître mu'tazilite Abu 'Ali al-Jubba'i. Sa rupture avec ce courant, relatée notamment par **Ibn 'Asakir** dans *Tabyin Kadhib al-Muftari*, est restée célèbre : selon la tradition biographique, le Prophète ﷺ lui serait apparu en songe à plusieurs reprises, lui ordonnant d'abandonner le rationalisme mu'tazilite pour défendre les croyances transmises par les *Ahl al-Hadith*. Ce qui rend Al-Ash'ari unique n'est pas seulement ce retour à l'orthodoxie, mais la méthode qu'il choisit pour l'accomplir : il conserve les outils intellectuels du *kalam* (la dialectique rationnelle) qu'il maîtrisait parfaitement, mais les retourne désormais contre ses anciens maîtres, pour démontrer **rationnellement** la cohérence des croyances héritées des premières générations.

### Une école qui a armé l'Islam face au scepticisme philosophique

C'est précisément là que réside l'apport le plus précieux de l'école ash'arite : elle a doté la communauté musulmane d'un arsenal d'arguments rationnels pour répondre aux attaques philosophiques, qu'elles viennent des héritiers de la philosophie grecque, des courants matérialistes ou, plus tard, du scepticisme moderne. **Al-Baqillani** (m. 1013), dans son *Kitab al-Tamhid*, élabore des démonstrations logiques rigoureuses de l'existence d'Allah et de la véracité de la prophétie. **Abu al-Ma'ali al-Juwayni** (m. 1085), dans son *Al-Irshad*, systématise davantage encore cette argumentation, avant de former l'un des plus grands esprits de l'histoire islamique : **Abu Hamid al-Ghazali** (m. 1111), dont l'œuvre est déjà très largement présentée dans cette application, et dont le *Tahafut al-Falasifa* ("L'Incohérence des Philosophes") demeure l'une des réfutations les plus abouties jamais écrites contre les dérives de la philosophie hellénisante d'Ibn Sina et d'Al-Farabi.

L'école se poursuit avec **Fakhr al-Din al-Razi** (m. 1209), théologien-exégète dont le *Tafsir al-Kabir* mobilise sans relâche les outils du kalam au service de l'exégèse coranique, puis se diffuse à travers des générations de grands savants du hadith et du fiqh — **Al-Nawawi** (m. 1277, déjà cité dans nos articles sur les Adhkar et les Sunan al-Fitra), **Ibn Hajar al-Asqalani** (m. 1449, le grand commentateur de *Sahih al-Bukhari*), ou encore **Taj al-Din al-Subki** (m. 1370), dont les *Tabaqat al-Shafi'iyya al-Kubra* dressent un panorama biographique de générations entières de savants shafi'ites ash'arites. C'est cette école qui devient, à travers ces figures, la théologie officiellement enseignée à **Al-Azhar** au Caire, à la **Qarawiyyin** de Fès et à la **Zaytuna** de Tunis — institutions qui ont formé, et forment toujours, l'essentiel du corps savant du monde arabo-musulman sunnite.

### L'intérêt durable de cette méthode

L'apport ash'arite ne se limite pas à un moment historique révolu. Sa valeur demeure intacte pour le croyant contemporain confronté à des interrogations philosophiques sophistiquées sur l'existence de Dieu, le problème du mal, ou la cohérence rationnelle de la foi : l'école ash'arite offre un vocabulaire et des arguments précis pour répondre à ces questions sans se contenter d'un simple appel à la foi, montrant que croyance et raison ne sont jamais en contradiction lorsqu'elles sont correctement articulées — un message d'une actualité évidente dans un monde saturé de discours matérialistes et scientistes.

## L'École Maturidite : L'Équilibre entre Raison et Texte

### Une genèse indépendante, à l'autre bout du monde musulman

Presque exact contemporain d'Al-Ash'ari, **Abu Mansur al-Maturidi** (m. 944) développe à Samarcande, en Asie centrale, une synthèse théologique très largement convergente avec celle d'Al-Ash'ari, mais élaborée de manière totalement **indépendante** — les deux hommes ne se sont jamais rencontrés, n'ont jamais correspondu, et leurs œuvres respectives se sont développées dans des contextes intellectuels distincts, l'un à Bagdad au cœur du monde arabe, l'autre à la frontière du monde turco-persan, confronté notamment aux doctrines manichéennes et zoroastriennes locales. Cette double genèse indépendante, aboutissant à des conclusions très largement similaires, est elle-même considérée par de nombreux savants comme un signe de la solidité de l'orthodoxie qu'ils défendaient tous deux : deux esprits brillants, séparés par des milliers de kilomètres, parvenant presque aux mêmes conclusions face aux mêmes défis rationalistes.

Dans son œuvre maîtresse, *Kitab al-Tawhid*, Al-Maturidi défend avec une rigueur remarquable l'équilibre entre la raison (*'aql*) et la révélation (*naql*), accordant à la raison humaine une capacité réelle, quoique limitée, à reconnaître certaines vérités fondamentales — notamment l'obligation de remercier le Bienfaiteur (*shukr al-mun'im*) — avant même la venue d'une révélation prophétique explicite, une position légèrement plus optimiste sur les capacités de la raison naturelle que celle généralement défendue par les Ash'arites.

### Quelques nuances qui distinguent les deux écoles

Sur des points techniques précis, Maturidisme et Ash'arisme se distinguent subtilement : la définition exacte de la foi (*Iman*), la possibilité ou non de dire "je suis croyant, si Allah le veut" (*al-istithna fi al-iman*, formule de prudence spirituelle que les Maturidites jugent généralement déconseillée, contrairement à de nombreux Ash'arites et Atharis qui la valorisent comme marque d'humilité), ou encore certaines formulations sur la nature exacte de l'acte humain et sa relation à la Volonté divine. Ces divergences, documentées avec précision dans les manuels classiques de comparaison comme le *Sharh al-'Aqa'id al-Nasafiyya* d'Al-Taftazani (m. 1390), demeurent toutefois secondaires au regard de l'accord profond des deux écoles sur l'ensemble des questions fondamentales.

### Une école qui a porté la foi de centaines de millions de croyants

L'importance historique du Maturidisme est immense, quoique souvent sous-estimée en France où l'on parle plus volontiers d'Ash'arisme. Adossé à l'école juridique hanafite — de très loin la plus répandue numériquement dans le monde musulman —, le Maturidisme devient la théologie officielle de l'**Empire ottoman** pendant six siècles, la doctrine de référence de l'ensemble de l'**Asie centrale**, et la base théologique de la quasi-totalité des grandes écoles religieuses du **sous-continent indien et pakistanais**, qu'elles se rattachent à la sensibilité Deobandi ou Barelvi. Concrètement, cela signifie qu'une part considérable — sans doute la majorité — des musulmans du monde, notamment d'origine turque, afghane, pakistanaise, indienne ou bangladaise, ont hérité, souvent sans le savoir précisément, d'une théologie maturidite transmise de génération en génération.

### L'intérêt durable de cette méthode

La grande force du Maturidisme tient à son équilibre mesuré : ni le rejet de la raison qui caractériserait une lecture trop rigide des textes, ni l'excès de spéculation philosophique qui a pu, chez certains héritiers tardifs d'autres courants, s'éloigner de la simplicité du message coranique. Cet équilibre a permis à des empires multiethniques considérables, rassemblant des populations turques, arabes, kurdes, balkaniques et caucasiennes, de partager une théologie commune suffisamment robuste sur le plan intellectuel pour dialoguer avec les sciences et les philosophies environnantes, tout en restant suffisamment fidèle au texte révélé pour rester accessible au croyant ordinaire — une leçon de stabilité doctrinale précieuse pour quiconque s'intéresse à la manière dont une civilisation peut conjuguer unité spirituelle et diversité culturelle.

## L'École Athari : La Fidélité Vivante aux Premières Générations

### Une école née du sang et de la patience d'un seul homme

L'école athari (de *athar*, "la trace" laissée par le Coran, la Sunna et la compréhension des trois premières générations bénies, les *Salaf al-Salih*) trouve sa figure fondatrice dans l'imam **Ahmad ibn Hanbal** (m. 855), déjà présenté dans cette application comme fondateur de l'école juridique hanbalite. Comme nous l'avons relaté dans notre précédent article, c'est durant l'Inquisition mu'tazilite (*Al-Mihna*), entre 833 et 848, qu'Ahmad ibn Hanbal, emprisonné et flagellé pour avoir refusé de proclamer que le Coran était une parole créée, devient le symbole vivant de la résistance des *Ahl al-Hadith* face au rationalisme d'État. **Al-Dhahabi**, dans *Siyar A'lam al-Nubala'*, rapporte avec une admiration manifeste la constance de cet homme qui, sous la torture, ne cessait de répéter sa fidélité au sens apparent des textes hérités du Prophète ﷺ et de ses Compagnons.

### Une méthode fondée sur la simplicité et la transmission directe

La méthode athari privilégie, par principe, la transmission directe (*naql*) sur la spéculation rationnelle (*'aql*) en matière de croyance, sans pour autant rejeter l'usage de la raison dans l'absolu — elle l'emploie simplement comme outil de compréhension et de défense des textes, et non comme méthode première d'établissement des croyances. Sur les attributs divins, comme nous l'avons détaillé précédemment à travers les exemples de l'Établissement sur le Trône, de la Main ou du Visage d'Allah, l'école athari affirme le sens apparent des textes tout en niant catégoriquement toute ressemblance avec les attributs créés — une formule résumée par la célèbre phrase de l'imam Malik : *"al-Istiwa ghayru majhul, wal-kayfu ghayru ma'qul"*.

Cette méthode trouve son expression la plus accessible dans le petit traité d'**Ibn Qudama al-Maqdisi** (m. 1223), *Lum'at al-I'tiqad*, conçu comme un manuel de croyance destiné aux débutants, puis sa systématisation savante la plus aboutie dans les œuvres d'**Ibn Taymiyya** (m. 1328), notamment *Al-'Aqida al-Wasitiyya* et *Al-Fatwa al-Hamawiyya al-Kubra*, et son rayonnement spirituel le plus profond chez son disciple **Ibn Qayyim al-Jawziyya** (m. 1350), déjà très largement cité dans nos articles sur le Sabr, l'Amour d'Allah et les sciences du hadith.

### Une renaissance contemporaine mondiale

Le XVIIIe siècle voit un réformateur du Najd, **Muhammad ibn Abd al-Wahhab** (m. 1792), reprendre le flambeau de cette méthode atharie héritée d'Ibn Taymiyya, avec une insistance particulière sur la purification du culte contre certaines pratiques populaires jugées contraires au Tawhid. Le XXe siècle voit cette même méthode se diffuser à l'échelle mondiale, portée par des savants d'une grande rigueur dans la science du hadith comme **Nasir al-Din al-Albani** (m. 1999), ou par les grandes figures institutionnelles saoudiennes **Abd al-Aziz ibn Baz** (m. 1999) et **Muhammad ibn Salih al-'Uthaymin** (m. 2001), dont l'enseignement, diffusé à travers l'Université Islamique de Médine et d'innombrables traductions, a façonné une part très significative du paysage religieux contemporain, y compris parmi de nombreux jeunes musulmans de France en quête de repères textuels clairs.

### L'intérêt durable de cette méthode

La grande force de l'école athari réside dans son accessibilité et sa simplicité revendiquées : elle ne demande pas au croyant ordinaire de maîtriser les subtilités de la logique aristotélicienne pour affermir sa foi, mais l'invite à une relation directe et confiante avec le texte révélé, tel que l'ont compris les compagnons du Prophète ﷺ eux-mêmes — ceux qui ont vécu la révélation dans sa chair et n'ont jamais eu besoin d'outils dialectiques pour croire avec certitude et agir avec droiture. Cette insistance sur le retour aux sources, sur la cohérence entre la croyance et la pratique quotidienne, et sur une certaine méfiance salutaire envers les spéculations qui éloigneraient le cœur du Coran et de la Sunna, répond à un besoin réel et légitime : celui de croyants cherchant, dans un monde d'incertitudes intellectuelles, un ancrage textuel stable et vérifiable.

## La Convergence : Un Texte Que Tous Honorent

Il existe un document remarquable qui illustre, mieux que tout argument théorique, la profondeur du socle commun entre ces trois écoles : *Al-'Aqida al-Tahawiyya*, court traité rédigé par l'imam **Abu Ja'far al-Tahawi** (m. 933), juriste hanafite égyptien contemporain d'Al-Ash'ari et d'Al-Maturidi. Ce texte, qui résume en quelques pages l'essentiel de la croyance sunnite, a été commenté, étudié et enseigné à travers les siècles par des savants de sensibilités théologiques différentes — du commentaire d'**Ibn Abi al-'Izz** (m. 1390), de tendance nettement atharie, aux nombreux commentateurs maturidites et ash'arites qui l'ont également adopté comme texte de référence dans leurs propres cercles d'enseignement. Que des générations de savants aux méthodes différentes aient pu se retrouver, pendant un millénaire, autour d'un même texte fondateur, dit assez la solidité du socle qui les unit, par-delà la diversité de leurs approches.

## Conclusion : Trois Routes, Une Même Destination

Étudier ces trois écoles avec sérieux n'est pas un exercice de curiosité académique réservé aux spécialistes : c'est la condition d'un débat apaisé, informé et respectueux entre musulmans, à l'opposé des polémiques stériles qui opposent aujourd'hui, parfois avec une violence verbale regrettable — notamment sur les réseaux sociaux — des partisans peu formés de chaque courant. Le Coran lui-même appelle les croyants à l'unité par-delà leurs différences méthodologiques légitimes : *"Et cramponnez-vous tous ensemble au câble d'Allah, ne soyez pas divisés"* (Sourate Al-Imran, 3:103), tandis que le Prophète ﷺ a comparé les croyants à *"un seul corps : si un membre souffre, c'est tout le corps qui ressent la douleur"* (Sahih al-Bukhari, n°6011 ; Sahih Muslim, n°2586). Ash'arites, Maturidites et Atharis ont chacun, à leur manière et selon leur époque, défendu avec sincérité le même Tawhid, contre les mêmes dérives, pour le bénéfice de la même communauté. Connaître précisément leurs apports respectifs, plutôt que de réduire l'un à une caricature rationaliste et l'autre à une caricature littéraliste, est le commencement de cette unité que le Coran nous ordonne de préserver.

---

**Sources et bibliographie :**
- **Sourate Al-Qiyamah**, 75:22-23 — la Vision d'Allah au Paradis, point d'accord unanime des trois écoles.
- **Sourate Al-Imran**, 3:103 — l'appel coranique à l'unité de la communauté.
- **Sahih al-Bukhari**, n°6011 ; **Sahih Muslim**, n°2586 — la comparaison des croyants à un seul corps.
- **Al-Ash'ari**, *Al-Ibana 'an Usul al-Diyana* et *Maqalat al-Islamiyyin* — les œuvres fondatrices de l'école ash'arite.
- **Ibn 'Asakir**, *Tabyin Kadhib al-Muftari* — biographie d'Al-Ash'ari et récit de sa conversion.
- **Al-Baqillani**, *Kitab al-Tamhid* ; **Al-Juwayni**, *Al-Irshad* ; **Al-Ghazali**, *Tahafut al-Falasifa* — les grandes œuvres de systématisation ash'arite.
- **Al-Subki**, *Tabaqat al-Shafi'iyya al-Kubra* — panorama biographique des grands savants ash'arites.
- **Al-Maturidi**, *Kitab al-Tawhid* — l'œuvre fondatrice de l'école maturidite.
- **Al-Taftazani**, *Sharh al-'Aqa'id al-Nasafiyya* — comparaison technique entre Ash'arisme et Maturidisme.
- **Ahmad ibn Hanbal** et le récit de la Mihna — **Al-Dhahabi**, *Siyar A'lam al-Nubala'*.
- **Ibn Qudama al-Maqdisi**, *Lum'at al-I'tiqad* ; **Ibn Taymiyya**, *Al-'Aqida al-Wasitiyya* et *Al-Fatwa al-Hamawiyya al-Kubra* — les textes de référence de l'école athari.
