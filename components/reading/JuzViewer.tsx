    ...
    return (
        <div className="pb-24">
            ...
            <TafsirModal
                ...
                onNavigate={(dir) => {
                    const currentIdx = ayahs.findIndex(a => a.surahNumber === tafsirState.surahNumber && a.numberInSurah === tafsirState.ayahNumber);
                ...
                hasNext={ayahs.findIndex(a => a.surahNumber === tafsirState.surahNumber && a.numberInSurah === tafsirState.ayahNumber) !== -1 && ayahs.findIndex(a => a.surahNumber === tafsirState.surahNumber && a.numberInSurah === tafsirState.ayahNumber) < ayahs.length - 1}
                hasPrev={ayahs.findIndex(a => a.surahNumber === tafsirState.surahNumber && a.numberInSurah === tafsirState.ayahNumber) > 0}
            />
